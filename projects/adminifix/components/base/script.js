...
let components = {
	...
	highlight: {
		selector: '.highlight',
		styles: './components/highlight/darcula.min.css',
	...
	flotchart: {
		...
		init: function ( nodes ) {
			var options = {
				colors: ['#3e84d7', '#fbb81f', '#29d999', '#fb6820', '#55b6ef', '#6c757d'],
				grid: {
					show: true,
					aboveData: true,
					color: '#2f3c45',
				...
				xaxis: {
					color: '#41494d', // color for value in flotchart.scss
				},
				yaxis: {
					color: '#41494d' // color for value in flotchart.scss
				},
				...
				let
					...
					clickHandler = function () {
						...
						this.multiSwitch.targets.forEach( ( function ( target ) {
							console.log( '[navigationSwitch]', this.multiSwitch.state );
